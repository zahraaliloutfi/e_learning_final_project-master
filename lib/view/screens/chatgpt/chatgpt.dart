...
import 'package:e_learning_final_project/view/global/utill/app_constants.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text("ChatGPT", style: TextStyle(color: ColorResources.textColor(context)),),
        actions: [
          IconButton(
            onPressed: () async {
              await Services.showModalSheet(context: context);
            },
            icon:  Icon(Icons.more_vert_rounded, color: ColorResources.textColor(context)),
          ),
        ],
      ),
      body: SafeArea(
